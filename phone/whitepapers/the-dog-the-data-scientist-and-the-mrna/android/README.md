# The Dog, the Data Scientist, and the mRNA Vaccine · Android
...
is `com.aicraftspeopleguild.acg.papers.thedogthedatascientistandthemrna` so this app coexists with its sibling papers
on one device.
