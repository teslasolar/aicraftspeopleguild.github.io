# 🌸 ASS-OS BLOOM PROMPT — THE IRRATIONAL UNIVERSE · Android
...
is `com.aicraftspeopleguild.acg.papers.assosbloomprompttheirrational` so this app coexists with its sibling papers
on one device.
