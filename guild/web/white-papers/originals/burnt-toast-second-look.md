---
title: "Structural Toast Carbonization: A Failure Mode Distinct from Voluntary Technical Debt Acquisition"
slug: burnt-toast-second-look
authors: [Thomas Frumkin, Guild Submission, Research Paper, Second Look]
summary: "Thomas Frumkin reflects on Kelly Hohman's toast-burning research paper"
status: published
site_href: burnt-toast-second-look.html
---
...
1. Degraded output is the modal output of the production process, not a deviation from it.
2. No individual participant experiences themselves as causally responsible for the degradation. Each contribution, examined locally, satisfies local quality criteria.
3. A stable population of remediation workers exists, organized around ongoing degradation as a standing workload.
4. Interventions directed at the source of the degradation are suppressed by mechanisms invisible to participants.
5. The organization's operative vocabulary has drifted such that the degraded state is the unmarked referent of terms that originally denoted the un-degraded state.
...
4. Argyris, C. & Schön, D. (1978). *Organizational Learning: A Theory of Action Perspective*. Addison-Wesley.
5. McConnell, S. (1997). *Technical Debt*. IEEE Software.
