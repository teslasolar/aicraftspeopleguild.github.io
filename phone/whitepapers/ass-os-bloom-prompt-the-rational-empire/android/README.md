# 🌸 ASS-OS BLOOM PROMPT — THE RATIONAL EMPIRE · Android
...
is `com.aicraftspeopleguild.acg.papers.assosbloomprompttherationalempire` so this app coexists with its sibling papers
on one device.
